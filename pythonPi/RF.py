...
payload = [0.0]
payload2 = struct.pack('hf', 0, 20)
print(payload2)

test = struct.unpack('hf', payload2)
print(test)
print(struct.calcsize('hf'))
...
radio.payload_size = struct.calcsize('hf') #payload2; #struct.calcsize("<f")
